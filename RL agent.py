# import relevent libraries and modules
...
class DQN:
    """ 
    Deep Q Network <-- the algorithm used to train the agent
    """

    # initializing the parameters and the model 
    def __init__(self, env, params):
        ...
        self.model = self.build_model() # initializing the model

    # building and compiling the model and returning it (I'm using a sequential model)
    ...
    # storing the experience in the memory
